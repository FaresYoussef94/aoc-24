...
| [Day 16](./src/bin/16.rs) | `46.2ms` | `46.9ms` |
| [Day 17](./src/bin/17.rs) | `2.2µs` | `8.0µs` |
| [Day 18](./src/bin/18.rs) | `18.9ms` | `318.6µs` |
| [Day 19](./src/bin/19.rs) | `23.7ms` | `171.5ms` |
| [Day 20](./src/bin/20.rs) | `10.1ms` | `8.7ms` |
| [Day 21](./src/bin/21.rs) | `1.1µs` | `15.0µs` |
| [Day 22](./src/bin/22.rs) | `26.3ms` | `536.9ms` |
| [Day 23](./src/bin/23.rs) | `181.3ms` | `554.9ms` |
| [Day 24](./src/bin/24.rs) | `64.1µs` | `2.1s` |
| [Day 25](./src/bin/25.rs) | `502.2µs` | `26.0ns` |
